...
class ProfilePage extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24.0),
            _buildAppPreferences(context, settingsProvider),
            const SizedBox(height: 24.0),
            ...
            Center(
              child: ElevatedButton.icon(
                onPressed: () {
                  ...
                  // Redirection is handled by GoRouter because authProvider is a refreshListenable
                },
  ...
  Widget _buildAccountSettings(BuildContext context, SettingProvider settings) {
    ...
    if (settings.selectedCurrency == AppCurrency.LKR)
      currencyDisplay = "LKR (Rs.)";
    else if (settings.selectedCurrency == AppCurrency.USD)
      currencyDisplay = "USD (\$)";
    else
      currencyDisplay = "EUR (€)";
  ...
  Widget _buildAppPreferences(BuildContext context, SettingProvider settings) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        Card(
          ...
          child: Column(
            children: [
              ...
              _buildProfileListItem(context, Icons.language, 'Language', () {
